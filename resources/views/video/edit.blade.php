            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Video Link</h4>
                                <h6 class="card-subtitle"> Make your video useful!</h6>
                                        ...
                                        <div class="col-lg-12 card-outline-info">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! Form::open(['action' => ['VideoController@update',$video->id], 'role' => 'form', 'method' => 'POST', 'enctype'=>'multipart/form-data']) !!} 
                                                    {{Form::hidden('_method', 'PUT')}}
                                                    <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label>Title</label>
                                                                        <input type="text" value="{{$video->title}}" name="title" class="form-control" required placeholder="Title">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>URL</label>
                                                                        <input type="text" value="{{$video->url}}" name="url" class="form-control" required placeholder="Video Link">
                                                                    </div>
                                                                    <hr>
