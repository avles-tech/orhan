            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Orhan's Resources</h4>
                                <h6 class="card-subtitle">Share your validated report!</h6>
                                @include('inc.messages')
                                <div class="table-responsive m-t-40">
                                    <div class="clearfix">
                                        <a href="/resourceSection/create" class="btn btn-sm btn-success"><i class="ace-icon fa fa-plus bigger-80"></i> Uplaod File</a>
                                         <a href="/resourceSection" class="btn btn-sm btn-warning"><i class="ace-icon fa fa-refresh bigger-80"></i> Relaod</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @if(count($resources)>0)
                                            ...
                                            <tr class="center">
                                            {!!Form::open(['action' => ['ResourceController@destroy', $resource->id], 'method' => 'POST', 'class' => 'pull-right', 'onsubmit' => 'return confirmDelete()'])!!}
                                            {!! Form::hidden('_method', 'DELETE')!!}
                                                <td>
                                                    <img style="width:100px;height:60px; border-style: solid; border-color: #92a8d1;border-width: 1.5px;" src="/images/pdf.png" class="img-responsive" alt="{{$resource->name}}">
                                                </td>
                                                <td>{{$resource->name}}</td>
                                                <td><div class="truncate-ellipsis-title">{{ $resource->file}}</div></td>
                                                <td><div class="truncate-ellipsis">{{$resource->description}}</div></td>
                                                <td>{{$resource->updated_at}}</td>
                                                <td>
                                                    
                                                <a class="btn btn-success btn-rounded" target="_blank" href="/Resource">
                                                    <i class="fa fa-eye"></i>                                            
                                                </a>
                                                <a class="btn btn-info btn-rounded" href="/resourceSection/{{$resource->id}}/edit">
