                                        ...
                                        <div class="col-lg-12 card-outline-info">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {!! Form::open(['action' => ['GalleryController@update',$gallery->id], 'role' => 'form', 'method' => 'POST', 'enctype'=>'multipart/form-data']) !!} 
                                                    {{Form::hidden('_method', 'PUT')}}
                                                    <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label>Name</label>
                                                                        <input type="text" value="{{$gallery->name}}" name="name" class="form-control" required placeholder="Gallery Name">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Cover Image</label>
                                                                        <div class="form-group">
                                                                            <img class="well" id="myImg" style="width:100px;height:100px;" src="/Uploads/gallery_cover_images/{{$gallery->cover_image}}" class="img-responsive" alt="{{$gallery->cover_image}}">
                                                                        </div>
                                                                        <div class="form-group">
